...
saveas(gcf,'pic_normal/original.png');
...
saveas(gcf,'pic_normal/pre_eq_without_mod.png');
...
saveas(gcf,'pic_normal/pre_eq_with_mod.png');
...
saveas(gcf,'pic_normal/out_without_mod.png');
...
saveas(gcf,'pic_normal/out_with_mod.png');
